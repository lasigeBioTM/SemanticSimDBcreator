...
@jit(target="cuda")
def calculate_sim_it1_it2_test_gpu(it1, e1, db_name, chebi_ids):
    for it2 in chebi_ids:
        if check_if_pair_exist(db_name, it1, it2) == False:
...
def calculate_semantic_similarity_gpu(chebi_ids, db_name):
    ...
    for it1 in chebi_ids:
        ...
        calculate_sim_it1_it2_test_gpu(it1, e1, db_name, chebi_ids)
...
if __name__ == '__main__':
    ...
    # chebi_semantic_sim = "chebi_semantic_sim_cherm_20_200"
    # dataset = "/mlData/cheRM_dataset/cheRM_20_200.csv"
    ...
    # calculate_semantic_similarity_gpu(chebi_ids, chebi_semantic_sim)
